...
import { NotificationProvider } from './context/NotificationContext'; // 1. Importa o novo provider
...
export default function App() {
  return (
    <AuthProvider>
      {/* 2. Envolve a navegação com o NotificationProvider */}
        ...
        <NavigationContainer>
          <Stack.Navigator>
            ...
            <Stack.Screen 
              ...
              options={{ title: 'Painel do Professor', ...headerStyle }}
            />
            <Stack.Screen 
              name="GerenciarEventos" 
              component={GerenciarEventos} 
              options={{ title: 'Gerir Eventos', ...headerStyle }}
            />
          </Stack.Navigator>
        </NavigationContainer>
      </NotificationProvider>
